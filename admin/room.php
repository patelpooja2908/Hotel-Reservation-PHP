	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<a class = "btn btn-success" href = "add_room.php"><h3><i class = "glyphicon glyphicon-plus"></i><i class="fa-solid fa-door-closed"></i> Add Room</h3></a>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					...
					?>	
						<tr>
							...
							<td><center><a class = "btn btn-warning" href = "edit_room.php?room_id=<?php echo $fetch['room_id']?>"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
							<a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_room.php?room_id=<?php echo $fetch['room_id']?>"><i class="fa-solid fa-trash"></i> Delete</a></center></td>
						</tr>
					<?php
						}
					?>	
